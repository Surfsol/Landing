            ...
            <div className="content">
              <div className="content-box">
                ...
                <p>
                  ...
                  <strong> CRUD</strong> operations: Register, Login, .post,
                  .get, .delete, forms, responsive design
                </p>
            ...
            <div class="content">
              <div class="content-box">
                ...
                <p>
                  ...
                  Collaborated with backend and Data Science teams. Register,
                  Login, .post, .get, .put, .delete, forms, responsive design.
                </p>
            ...
            <div class="content">
              <div class="content-box">
                ...
                <p>
                  ...
                  operations on the database. Register, Login, .post, .get,
