    ...
    <>
      ...
      <section className="sautiBody">
        ...
        <div className="sautiTeam">
          <h1>Our Team</h1>
          <p>
            Our team consisted of 6 fullstack web developers. Everyone worked remotely.
          </p>
        </div>
        <div className="sautiProcess">
          ...
          <ul>
            <li>
              First, we took the time to understand the existing architecture. The backend
              consisted of Node.js, Graphql and a MySQL database.
              The Frontend was using React, Graphql and Nivo to display charts.
            </li>
            <li>
              {" "}
              After understanding the architecture, we took the time to research ways
              we could improve upon it.  We spent a lot of time researching Graphql and Apollo,
              and Nivo for displaying graphs. 
            </li>
            <li>
        ...
        <div className="sautitech">
          ...
          <h3>
            <span className="colorBlue">React</span>: When our team inherited the project
            React was already being used.  We stuck with React because it was
            easy to build additional components on top of the existing page and for 
            Reacts ability to conditionally Render components. 
            This was especially valuable when we blocked off certain functionality 
            based on the user's tier.
          </h3>
          <img className="techsUsed" src={graphql} />
          <h3>
            <span className="colorBlue">Graphql</span>: We inherited the project with 
            graphql already implemented.  Graphql was a wise decision for this app due
            to its ability to query specific data.  Whereas, on a REST framework we would
            have to deal with many endpoints and do .get requests on large amounts of 
            unneeded data.
          </h3>
          ...
          <h3>
            <span className="colorBlue"> Material-UI</span>: We used material-ui to 
            implement modals used for logging in, registering and performing crud operation on
            user accounts.
          </h3>
          <h3>
